...
(defun deqn-get-useful-lines ()
  ...
  (while (not (eobp)) ;; <<  start while loop as long as not end of buffer
    ...
    (add-to-list 'deqn-buffer-lines curr-string)
    (forward-line 1))
  )
  
(defun deqn-get-parameters ()
  "Get variables from buffer."
